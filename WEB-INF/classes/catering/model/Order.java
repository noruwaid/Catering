...
public class Order {
	...
	public Order(int orderid, String product_id, String staff_id, String cust_email, String product_name,
			String date, String address, int orderQtty, double unitPrice, double totalamount) {
		super();
