				...
				<div class="row">
					<div class="col-sm-3">
						...
						<form method="POST" action="CheckoutController">
							<p><a href="/Catering/AccountController?action=customerAccount&user=<%= request.getAttribute("email")%>">Name</a></p>
						...
						<tr>
							...
							<td colspan="2">
								<table class="table table-condensed total-result">
									...
									<tr>
										<td><a class="btn btn-primary pull-left" href="">Update</a></td>
									</tr>
								</table>
							</td>
							</form>
